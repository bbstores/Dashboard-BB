        ...
        <div className="dailyTaskControls">
          ...
          <HelpButton
            help={{
              ...
              calculation: "Được giao theo Ngày Bắt Đầu; bàn giao theo Ngày Kiểm Duyệt. Tồn cuối ngày được tính đến 23:59 và gồm task bắt đầu trước hoặc trong chính ngày đó nếu tại thời điểm đang xét chưa được kiểm duyệt; hoặc đã kiểm duyệt nhưng trạng thái hiện tại vẫn In Progress. Toàn bộ chỉ số task tồn không tính Outsource, công đoạn Trainning, Pending/Cancel và Archived.",
